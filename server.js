...
if(process.env.DEPLOY == "dev") {
  ...
  Try it out in your browser: http://localhost:${port}/fulcrum-qapi/FeatureServer/0/query
  Or on the command line: curl --silent http://localhost:${port}/fulcrum-qapi/FeatureServer/0/query?returnCountOnly=true
